            ...
            if i[:3].lower()=='Act'.lower() and i[3] ==' ':
                ...
                if ikl not in act_dict:
                    ...
                    if len(lact)==0:
                        ...
                        pact.append(ikl)
                        lact.append(u)
            # print i,u,len(i.split()[0])
            # print i[:5].lower() ,i[6],'hhhhhhhhhhhh'  
            # ii=i.split()   
            if i.split()[0].lower()=='Scene'.lower():# and i[6]==' ':
                ikls=i.split()[1][:-1]
                # print i,u
...
def create_graph_dict(act_dict,pers_l,pers_dict,u,attribute_dict={}):
    ract_dic={}
    graph_dic={}
